    ...
    return (
        <BeforeLoginLayout>
            <BlurView intensity={80} tint='dark' style={{
                ...
                <TouchableOpacity on onPress={() => navigation.navigate('Forget')} style={{ alignSelf: 'flex-end', marginHorizontal: 1, top: 5, }}>
                    <Text variant="medium" style={styles.subheading}>Forget Password</Text>
                </TouchableOpacity>
